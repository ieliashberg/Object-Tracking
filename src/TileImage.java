...
public class TileImage implements PixelFilter {
    ...
    public DImage processImage(DImage img) {
        ...
        int width = imgWidth * Integer.parseInt(inputValue);
        System.out.println(width);
        //int height = imgHeight * Integer.parseInt(JOptionPane.showInputDialog("Please input height"));
        String input2Value = JOptionPane.showInputDialog("Please input block size value (odd number only)");
        int height = (imgHeight) * Integer.parseInt(input2Value);
